...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiveDWAPI.Domain.Gf.DimAgeGroup", b =>
                {
                    b.Property<string>("AgeGroup")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("vAgeGroupGf", (string)null);
                });

            modelBuilder.Entity("LiveDWAPI.Domain.Gf.DimAgency", b =>
                {
                    b.Property<string>("Agency")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("vAgencyPartnerGf", (string)null);
                });

            modelBuilder.Entity("LiveDWAPI.Domain.Gf.DimIndicator", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("Indicator");
                    ...
                    b.ToView("vIndicatorGf", (string)null);
                });

            modelBuilder.Entity("LiveDWAPI.Domain.Gf.DimRegion", b =>
                {
                    b.Property<string>("County")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("vRegionFacilityGf", (string)null);
                });

            modelBuilder.Entity("LiveDWAPI.Domain.Gf.DimSex", b =>
                {
                    b.Property<string>("Sex")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("vSexGf", (string)null);
                });

            modelBuilder.Entity("LiveDWAPI.Domain.Gf.FactAggregateIndicator", b =>
                {
                    b.Property<string>("AgeGroup")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("CSAggregateBMGFIndicators", (string)null);
                });
